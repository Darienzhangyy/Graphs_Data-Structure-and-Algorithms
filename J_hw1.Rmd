...
(1) checks that if the graph is valid;if not, return an error message;
(2) checks if the length of the vector is equal to 1;
(3) create an adjacency matrix that is described as above;
(4) checks if the adjacency matrix is symmetric.
